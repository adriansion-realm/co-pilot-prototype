  ...
  const getTaskSet = () => {
    ...
    const taskSets = [
      ...
      [
        ...
        { id: 3, title: 'Provide clear bid comparison and contractor recommendation', completed: true, date: '12 days ago' },
        { id: 4, title: 'Review and finalize project scope with stakeholders', completed: false, date: 'Today' },
        { id: 5, title: 'Reschedule meeting to review bids and next steps', completed: false, date: 'in 6 days' },
        { id: 6, title: 'Confirm outcome regarding project award', completed: false, date: 'in 9 days' },
      ],
      [
        { id: 1, title: 'Send recap email for [1/22] call', completed: true, date: '5 days ago' },
        ...
        { id: 4, title: 'Call homeowner to review bid and plans', completed: false, date: '17 days ago' },
        { id: 5, title: 'Provide clear bid comparison and contractor recommendation', completed: false, date: '12 days ago' },
    ...
    <TooltipProvider>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          {/* Title with Chevron and Open Button */}
          <div className="flex items-center gap-1">
            ...
            {isHovered && (
              ...
              >
                <PanelRight className="w-4 h-4 text-[#0a0a0a]" />
                <span className="text-xs font-medium text-[#0a0a0a] leading-none">Open</span>
              </button>
            )}
          </div>
